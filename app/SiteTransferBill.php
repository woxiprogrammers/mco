...
class SiteTransferBill extends Model
{
    ...
    protected $fillable = [
        'inventory_component_transfer_id', 'bill_number', 'bill_date', 'subtotal', 'tax_amount',
        'extra_amount', 'extra_amount_cgst_percentage', 'extra_amount_sgst_percentage', 'extra_amount_igst_percentage',
        'extra_amount_cgst_amount', 'extra_amount_sgst_amount', 'extra_amount_igst_amount', 'total', 'remark', 'format_id', 'created_at', 'inventory_transfer_challan_id'
    ];
