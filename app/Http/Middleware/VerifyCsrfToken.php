...
class VerifyCsrfToken extends BaseVerifier
{
    ...
    protected $except = [
        ...
        '/quotation/check-product-remove','/extra-item/listing','/vendors/listing','/bank/listing','/checklist/category-management/listing','purchase/material-request/get-materials','/purchase/material-request/get-units','/purchase/material-request/get-projects','purchase/material-request/get-clients','purchase/material-request/get-users','purchase/material-request/create'
    ];
}
