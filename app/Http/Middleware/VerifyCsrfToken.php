...
class VerifyCsrfToken extends BaseVerifier
{
    ...
    protected $except = [
        ...
        '/drawing/images/display-images/*','/drawing/images/delete-temp-product-image/','/drawing/images/get-data/','/user/get-permission','/peticash/salary-request/get-labours','/purchase/purchase-order/reopen','/change-project-site'
