...
class VerifyCsrfToken extends BaseVerifier
{
    ...
    protected $except = [
        ...
        '/asset/maintenance/request/listing','/asset/maintenance/request/approval/listing','/peticash/peticash-management/purchase/transaction/display-images','/peticash/peticash-management/purchase/transaction/delete-temp-product-image'
