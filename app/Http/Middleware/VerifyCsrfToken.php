...
class VerifyCsrfToken extends BaseVerifier
{
     ...
     */
    protected $except = [
        '/purchase/purchase-order/transaction/check-quantity','/purchase/purchase-order/get-component-details','/purchase/purchase-order/listing','purchase/purchase-order-bill/listing','/inventory/transfer/listing','/inventory/transfer/challen-generation','/subcontractor/bill/transaction/listing','/subcontractor/structure/listing','/material/check-name','/material/listing','/category/listing','/product/listing','/profit-margin/listing','/units/listing','/units/conversion/listing',
