...
class VerifyCsrfToken extends BaseVerifier
{
     ...
     */
    protected $except = [
        '/inventory/transfer/challen-generation','/subcontractor/bill/transaction/listing','/subcontractor/structure/listing','/material/check-name','/material/listing','/category/listing','/product/listing','/profit-margin/listing','/units/listing','/units/conversion/listing',
