...
class VerifyCsrfToken extends BaseVerifier
{
    ...
    protected $except = [
        ...
        '/quotation/check-product-remove','/extra-item/listing','/vendors/listing','/bank/listing','/checklist/category-management/listing','/asset/listing','/asset/image-upload/*','/asset/display-images/*','/asset/delete-temp-product-image'
    ];
}
