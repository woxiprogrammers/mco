...
class VerifyCsrfToken extends BaseVerifier
{
     ...
     */
    protected $except = [
        '/peticash/peticash-management/salary/listing','/purchase/purchase-order/transaction/check-quantity','/purchase/purchase-order/get-component-details','/purchase/purchase-order/listing','purchase/purchase-order-bill/listing','/inventory/transfer/listing','/inventory/transfer/challen-generation','/subcontractor/bill/transaction/listing','/subcontractor/structure/listing','/material/check-name','/material/listing','/category/listing','/product/listing','/profit-margin/listing','/units/listing','/units/conversion/listing',
        ...
        '/reports/listing/sales','/reports/listing/expense','/reports/listing/advance-expense','/material/display-images','/material/delete-temp-product-image','/salary-distribution/listing','/bill/listing/project-site'
    ];
}
