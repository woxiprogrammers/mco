...
class VerifyCsrfToken extends BaseVerifier
{
    ...
    protected $except = [
        ...
        'labour/listing','/peticash/master-peticash-account/listing','/peticash/sitewise-peticash-account/listing', '/peticash/peticash-approval-request/manage-purchase-list-ajax'
    ];
}
