...
class VerifyCsrfToken extends BaseVerifier
{
    ...
    protected $except = [
        ...
        '/purchase/purchase-order/change-status','/purchase/purchase-order/get-bill-details','/purchase/purchase-order/close-purchase-order','/awareness/file-management/file-upload','/awareness/file-management/get-files','/awareness/category-management/main-category-listing'
    ];
}
