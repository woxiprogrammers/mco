...
class AssetMaintenanceBill extends Model
{
    ...
    protected $fillable = ['asset_maintenance_id','amount','cgst_percentage','cgst_amount','sgst_percentage','sgst_amount','igst_percentage','igst_amount','extra_amount','bill_number','assets_bill_number'];
