                    ...
                    <div class="page-head">
                        <div class="container">
                            ...
                            <div class="page-title">
                                <h1>Edit Amount to Sitewise Peticash Account</h1>
                            </div>
                        </div>
                    </div>
                    <div class="page-content">
                        ...
                        <div class="container">
                            <ul class="page-breadcrumb breadcrumb">
                                <li>
                                    <a href="/peticash/sitewise-peticash-account/manage">Edit Sitewise Peticash Account</a>
                                    <i class="fa fa-circle"></i>
                                </li>
                                <li>
                                    <a href="javascript:void(0);">Edit Amount to Sitewise Peticash Account</a>
                                </li>
                            </ul>
                            <div class="col-md-12">
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-body form">
                                        <form role="form" id="edit-sitewise-account" class="form-horizontal" method="post" action="/peticash/sitewise-peticash-account/edit">
                                            {!! csrf_field() !!}
                                            <div class="form-body">
                                                <fieldset>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-md-3" style="text-align: right">
                                                            <label for="type" class="control-label">For Site</label>
                                                            <span>:</span>
                                                        </div>
                                                        <div class="col-md-6">
