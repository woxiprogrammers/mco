...
<body>
    ...
    <table border="1" style="padding-top: 20px; padding-bottom:20px " width="100%">
        ...
        <tr>
            <td colspan="4" style="font-size: 14px;font-weight:bolder;"> Challan No - {{$challan['challan_number']}}</td>
	    <td colspan="6" style="text-align:right;font-size: 14px;">Date - {{date('d/m/Y', strtotime($other_data['date']))}}</td>
        </tr>
        <tr style="font-size: 14px">
            <td colspan="10">Status of Challan - <b>{{$other_data['status_of_challan']}}</b></td>
        </tr>
        <!--<tr style="font-size: 14px">
	...
	<tr style="font-size: 14px">
            <td colspan=" 10" style="font-size: 14px"> Vehicle No - {{$other_data['vehicle_number']}}</td>
        </tr>

        <tr style="font-size: 14px">
            <td colspan=" 10" style="font-size: 14px"> Generated By - {{$user['name']}}</td>
        </tr>
        <tr style="font-size: 14px">
            <td colspan=" 10" style="font-size: 14px"> Remark - {{$remark}}</td>
        </tr>
        <tr>
            <td colspan=" 10"> &nbsp; </td>
        </tr>
