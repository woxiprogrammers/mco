        ...
        <div class="page-wrapper-row full-height">
            <div class="page-wrapper-middle">
                ...
                <div class="page-container">
                    <form role="form" id="create-category" class="form-horizontal" method="post" action="/dpr/create-category">
                        <!-- BEGIN CONTENT -->
                                            ...
                                            <div class="portlet-body form">
                                                ...
                                                <div class="form-body">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" name="category"style="width: 100%" required>
                                                        </div>
                                                    </div>
