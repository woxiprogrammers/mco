                                                ...
                                                <form role="form" id="createStructureBill" class="form-horizontal" action="/subcontractor/bill/create/{!! $subcontractorStructure['id'] !!}" method="post">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 date date-picker" data-date-end-date="0d" data-date-format="dd/mm/yyyy">
                                                            ...
                                                            <input type="text" style="width: 30%" name="bill_date" placeholder="Select Bill Date" value="{{date('Y/m/d')}}" id="date">
                                                        ...
                                                        <div class="col-md-6 date date-picker" data-date-end-date="0d" data-date-format="dd/mm/yyyy">
                                                            ...
                                                            <input type="text" style="width: 32%" name="performa_invoice_date" value="{{date('Y/m/d')}}" placeholder="Select Proforma Invoice Date" id="performa_invoice_date"/>
                                                            <button class="btn btn-sm default" type="button">
                                                                <i class="fa fa-calendar"></i>
                                                            </button>
                                                        </div>
