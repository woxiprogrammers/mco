                        ...
                        <div class="page-head">
                            <div class="container">
                                ...
                                <div class="page-title">
                                    <h1>Subcontractor Bill Listing</h1>
                                </div>
                            </div>
                        </div>
                        <div class="page-content">
                            ...
                            <div class="container">
                                <ul class="page-breadcrumb breadcrumb">
                                    <li>
                                        <a href="/subcontractor/structure/manage">Back</a>
                                                            ...
                                                            @if($user->roles[0]->role->slug == 'admin' || $user->roles[0]->role->slug == 'superadmin' || $user->customHasPermission('create-subcontractor-billing') || $user->customHasPermission('approve-subcontractor-billing'))
                                                                <div class="btn-group">
                                                                    <div id="sample_editable_1_new" class="btn yellow">
                                                                        <a href="/subcontractor/bill/create/{!! $subcontractorStructureId !!}" style="color: white">
