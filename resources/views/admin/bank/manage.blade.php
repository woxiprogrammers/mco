                    ...
                    <div class="page-content-wrapper">
                        <div class="page-head">
                            <div class="container">
                                ...
                                @if($user->roles[0]->role->slug == 'admin' || $user->roles[0]->role->slug == 'superadmin' || $user->customHasPermission('create-manage-bank'))
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="bankTable">
                                                    ...
                                                    <tr class="filter">
                                                        ...
                                                        <th> <input type="text" class="form-control form-filter" name="account_number" > </th>
                                                        <th> </th>
                                                        <th>
