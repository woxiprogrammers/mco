...
@section('title','Constro | Edit Bill')
                                                            ...
                                                            <tr id="id_{{$quotationSummaries[$iterator]['id']}}">
                                                                <td>
                                                                    @if(array_key_exists('current_quantity',$quotationSummaries[$iterator]->toArray()))
                                                                        <input class="product-checkbox" type="checkbox" id="id_{{$quotationSummaries[$iterator]['id']}}" name="quotation_summary_id[{{$quotationSummaries[$iterator]['id']}}]" value="{{$quotationSummaries[$iterator]['id']}}" checked onchange="getTotals()">
                                                                    @else
                                                                        <input class="product-checkbox" type="checkbox" id="id_{{$quotationSummaries[$iterator]['id']}}" name="quotation_summary_id[{{$quotationSummaries[$iterator]['id']}}]" value="{{$quotationSummaries[$iterator]['id']}}">
                                                                    @endif
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <span>{{$quotationSummaries[$iterator]->summary->name}}</span>
                                                                    <div class="input-group form-group" id="inputGroup">
                                                                        @if(array_key_exists('bill_description',$quotationSummaries[$iterator]->toArray()))
                                                                            <input type="hidden" class="product-description-id" name="quotation_summary_id[{{$quotationSummaries[$iterator]['id']}}][product_description_id]" id="product_description_id_{{$quotationSummaries[$iterator]['id']}}" value="{{$quotationSummaries[$iterator]['bill_product_description_id']}}">
                                                                            <input class="form-control product_description" type="text" id="product_description_{{$quotationSummaries[$iterator]['id']}}" name="quotation_summary_id[{{$quotationSummaries[$iterator]['id']}}][product_description]" value="{{$quotationSummaries[$iterator]['bill_description']}}">
                                                                        @else
                                                                            <input type="hidden" class="product-description-id" name="quotation_summary_id[{{$quotationSummaries[$iterator]['id']}}][product_description_id]" id="product_description_id_{{$quotationSummaries[$iterator]['id']}}">
                                                                            <input class="form-control product_description" type="text" id="product_description_{{$quotationSummaries[$iterator]['id']}}" name="quotation_summary_id[{{$quotationSummaries[$iterator]['id']}}][product_description]" disabled>
                                                                        @endif
                                                                ...
                                                                <td>
                                                                    @if(array_key_exists('current_quantity',$quotationSummaries[$iterator]->toArray()))
                                                                        <input class="form-control" type="text" id="rate_per_unit_{{$quotationSummaries[$iterator]['id']}}" name="quotation_summary_id[{{$quotationSummaries[$iterator]['id']}}][rate]" value="{{$quotationSummaries[$iterator]['rate_per_sqft']}}">
                                                                    @else
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <span id="used_quantity_{{$quotationSummaries[$iterator]['id']}}" hidden>{{$quotationSummaries[$iterator]['used_quantity']}}</span>
                                                                </td>
...
@section('javascript')
    ...
    <script src="/assets/custom/bill/new-bill-edit.js" type="text/javascript"></script>
