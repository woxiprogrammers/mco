            ...
            <div class="tab-content">
                    <table class="table table-bordered table-striped table-condensed flip-content" style="width:100%;overflow: scroll; " id="createBillTable">
                        ...
                        <tr id="id_{{$quotationProducts[$iterator]['id']}}">
                            ...
                            <td>
                                <!--<span>{{$quotationProducts[$iterator]}}</span>-->
                            ...
                            <td>
                                <span id="previous_quantity_{{$quotationProducts[$iterator]['id']}}">1<!--{{$quotationProducts[$iterator]['previous_quantity']}}--></span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="4" style="text-align: right"><input class="tax form-control" step="any" type="number" id="tax_percentage_{{$taxes[$j]['id']}}" name="tax_percentage[{{$taxes[$j]['id']}}]" value="{{$taxes[$j]['percentage']}}" onchange="calculateTax()" onkeyup="calculateTax()"></td>
                            <td>
