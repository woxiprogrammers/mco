                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="input-group" id="inputGroup">
                                                                        @if(array_key_exists('bill_description',$quotationProducts[$iterator]->toArray()))
                                                                            <input type="hidden" class="product-description-id" name="quotation_product_id[{{$quotationProducts[$iterator]['id']}}][product_description_id]" id="product_description_id_{{$quotationProducts[$iterator]['id']}}" value="{{$quotationProducts[$iterator]['bill_description_id']}}">
