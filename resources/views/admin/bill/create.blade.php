                        ...
                        <div class="page-content">
                            ...
                            <div class="container" style="width: 100%">
                                                ...
                                                <form role="form" id="new_bill" class="form-horizontal" action="/bill/create" method="post">
                                                    <div class="row">
                                                        <div class="form-group">
                                                            <div class="col-md-2 date date-picker" data-date-end-date="0d">
                                                                <label class="control-label" for="date">Bill Date : </label>
                                                                <input type="text" style="width: 30%" name="date" placeholder="Select Bill Date" id="date" value="{{date('m/d/Y')}}"/>
                                                            ...
                                                            <div class="col-md-4 date date-picker" data-date-end-date="0d">
                                                                ...
                                                                <input type="text" style="width: 32%" name="performa_invoice_date" placeholder="Select Proforma Invoice Date" id="performa_invoice_date" value="{{date('m/d/Y')}}"/>
                                                                <button class="btn btn-sm default" type="button">
                                                                    <i class="fa fa-calendar"></i>
                                                                </button>
                                                            </div>
                                ...
                                @else
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <b style="color: red">Please check whether you have created quotation.</b>
                                            <br/>
                                            <b>or</b>
                                            <br/>
                                            <b style="color: red">Please check whether you have assign bill type to quotation.</b>
                                        </div>
                                    </div>
                                @endif
                            </div>
