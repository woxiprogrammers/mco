...
<div>
    <table width="100%" border="1">
        ...
        @for($j = 0 ; $j < count($summary_data) ; $j++)
            <tr>
                <td colspan="6" style="text-align: left;background-color: #e2e2e2;"><b>{{$summary_data[$j]['summary_name']}}</b></td>
        ...
        <tr>
            <td colspan="6" style="background-color: #e2e2e2;font-size: 13px"><b><i>Rs. {!! $amount_in_words !!}.</i></b></td>
        </tr>
    </table>
</div>
<br>
