                                                                        ...
                                                                        <table class="table table-bordered" id="productTable" style="overflow: scroll;overflow-x: auto; overflow-y: auto">
                                                                            ...
                                                                            @for($iterator=0; $iterator < count($quotation->quotation_products); $iterator++)
                                                                                <tr id="Row{{$iterator}}">
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="form-group">
                                                                                            <input name="product_rate[{{$quotation->quotation_products[$iterator]->product_id}}]" class="form-control quotation-product-table" id="productRate{{$iterator}}" type="text" value="<? echo (\App\Helper\MaterialProductHelper::customRound($quotation->quotation_products[$iterator]->rate_per_unit,3)); ?>" title="<? echo (\App\Helper\MaterialProductHelper::customRound($quotation->quotation_products[$iterator]->rate_per_unit,3)); ?>" readonly>
                                                                                        </div>
                                                                                    </td>
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="form-group">
                                                                                            <input type="text" name="product_amount[{{$quotation->quotation_products[$iterator]->product_id}}]" class="form-control quotation-product-table product-amount" id="productAmount{{$iterator}}" value="<? echo (\App\Helper\MaterialProductHelper::customRound($quotation->quotation_products[$iterator]->rate_per_unit,3) * $quotation->quotation_products[$iterator]->quantity); ?>" title="<? echo (\App\Helper\MaterialProductHelper::customRound($quotation->quotation_products[$iterator]->rate_per_unit,3) * $quotation->quotation_products[$iterator]->quantity); ?>" readonly>
                                                                                        </div>
                                                                                    </td>
                                                                                    <td>
                                                                                        <div class="form-group">
                                                                                            <input type="text" name="product_discount_amount[{{$quotation->quotation_products[$iterator]->product_id}}]" class="form-control quotation-product-table product-discount-amount" id="productDiscountAmount{{$iterator}}" value="<? echo ((\App\Helper\MaterialProductHelper::customRound($quotation->quotation_products[$iterator]->rate_per_unit,3) * $quotation->quotation_products[$iterator]->quantity)-(\App\Helper\MaterialProductHelper::customRound($quotation->quotation_products[$iterator]->rate_per_unit,3)*$quotation->quotation_products[$iterator]->quantity*($quotation->discount/100))); ?>" title="<? echo ((\App\Helper\MaterialProductHelper::customRound($quotation->quotation_products[$iterator]->rate_per_unit,3) * $quotation->quotation_products[$iterator]->quantity)-(\App\Helper\MaterialProductHelper::customRound($quotation->quotation_products[$iterator]->rate_per_unit,3)*$quotation->quotation_products[$iterator]->quantity*($quotation->discount/100))); ?>" readonly>
                                                                                        </div>
                                                                                    </td>
                                                                                    <td>
                                                                                        <div class="form-group">
