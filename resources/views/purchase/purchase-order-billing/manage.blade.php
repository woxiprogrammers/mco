                                                    ...
                                                    <div class="table-container">
                                                        ...
                                                        <div class="table-scrollable profit-margin-table" style="overflow: scroll !important;">
                                                            <table class="table table-striped table-bordered table-hover order-column" id="purchaseOrderBillTable">
                                                                ...
                                                                <tr class="filter">
                                                                    <th style="width: 11%"><input style="width: 90%; margin-left: 5%" type="text" name="project_name" id="project_name" class="form-control form-filter"></th>
                                                                    <th style="width: 11%"><input style="width: 90%; margin-left: 5%" type="text" name="system_bill_number" id="system_bill_number" class="form-control form-filter"></th>
                                                                    ...
                                                                    <th style="width: 11%"> <input style="width: 90%; margin-left: 5%" type="text" name="bill_number" id="bill_number" class="form-control form-filter"> </th>
