    ...
    <table class="table table-striped table-bordered table-hover" id="challanComponentTable">
        ...
        <tbody>
            ...
            <tr class="component-row" id="componentRow-{{$component['reference_id']}}">
                <input type="hidden" name="component[{{$component['reference_id']}}][site_out_transfer_id]" value="{{$component['site_out_transfer_id']}}">
                ...
                <td><input type="number" name="component[{{$component['reference_id']}}][quantity]" class="component-vendor-relation"></td>
