<center><div id="myCarousel" class="carousel slide" data-ride="carousel" style="height: 200px;width: 500px">
    <!-- Indicators -->
    ...
    <div class="carousel-inner ">
        @foreach($drawing_image_latest_version as $drawing_image_latest_version)
         @if($drawing_image_latest_version['iterator'] == 0)
                <div class="item active"><a href="{{$drawing_image_latest_version['encoded_name']}}">
