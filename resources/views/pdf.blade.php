                        ...
                        <tr>
                            <td>
                                <table width="100%" style="text-align: center; ">
                                    <tr>
                                        <td style="font-size: 22px"><i>{!! env('COMPANY_NAME') !!}</i></td>
...
<table width="100%" style="font-size: 16px;" border="1">
    <tr>
        <td style="font-weight: lighter;" colspan="2"><b>Site :</b> 123</td>
    </tr>
    <tr>
        <td style="font-weight: lighter;" colspan="2"><b>Paid to :</b> 123</td>
    </tr>
    <tr>
        <td style="font-weight: lighter;" colspan="2"><b>Amount (in Words) :</b> 123</td>
    </tr>
    <tr>
        <td style="font-weight: lighter;" colspan="2"><b>Particulars :</b> 123</td>
    </tr>
</table>
...
<table style="font-size:15px" width="100%"{{-- border="1"--}}>
    <tr>
        ...
        <td width="25%" style="padding-top:40px"><div style="height: 30px;width: 100%;border: 1px solid black"></div></td>
        <td width= 30%" style="padding-top:40px;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Approved By</b> </td>
