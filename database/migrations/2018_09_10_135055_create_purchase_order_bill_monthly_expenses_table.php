...
class CreatePurchaseOrderBillMonthlyExpensesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('purchase_order_bill_monthly_expenses', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('purchase_order_bill_monthly_expenses');
    }
}
