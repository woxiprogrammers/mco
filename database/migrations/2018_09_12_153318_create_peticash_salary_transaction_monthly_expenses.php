...
class CreatePeticashSalaryTransactionMonthlyExpenses extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('peticash_salary_transaction_monthly_expenses', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('peticash_salary_transaction_monthly_expenses');
    }
}
