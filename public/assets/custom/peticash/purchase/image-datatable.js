var PeticashPurchaseTransactionImageUpload = function() {
    ...
    var e = function() {
        var e = new plupload.Uploader({
            ...
            url: "/peticash/peticash-management/purchase/transaction/image-upload?_token="+data,
            async:false,
...
jQuery(document).ready(function() {
    PeticashPurchaseTransactionImageUpload.init()
});