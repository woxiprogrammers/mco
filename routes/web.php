...
Route::group(['domain' => env('DOMAIN_NAME')], function () {
    ...
    Route::group(['prefix' => 'asset'], function () {
        ...
        Route::post('checkbox-state', array('uses' => 'Admin\AssetManagementController@assetCheckBoxState'));
        Route::get('checkbox-list', array('uses' => 'Admin\AssetManagementController@assetCheckBoxList'));
        Route::post('merge', array('uses' => 'Admin\AssetManagementController@assetMerge'));
