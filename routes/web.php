...
Route::group(['domain' => env('DOMAIN_NAME')], function(){
    ...
    Route::group(['prefix' => 'bill'],function(){
        ...
        Route::get('manage/project-site',array('uses' => 'Admin\BillController@getManageView'));
        Route::post('listing/project-site',array('uses' => 'Admin\BillController@billListing'));
        ...
        Route::get('manage/curren',array('uses' => 'Admin\BillController@getManageView'));
